...
X86_64_CORE_OBJECTS := \
	...
	$(MACOS_INT_DIR)/x86_64/source/library/macOS/platform.o
ARM64_CORE_OBJECTS := $(CORE_SOURCES:%.c=$(MACOS_INT_DIR)/arm64/%.o) \
	$(MACOS_INT_DIR)/arm64/source/library/macOS/platform.o
...
$(X86_64_BINARY): $(X86_64_OBJECTS) $(X86_64_DOWNLOAD_LIBRARY) \
		$(X86_64_LIBRARY) $(ALTIVECCORE)
	...
	@$(COMPILER_X64) -target x86_64-apple-macos$(MAC_MIN_X64) \
		...
		$(LDFLAGS) $(X86_64_OBJECTS) $(X86_64_DOWNLOAD_LIBRARY) \
		$(X86_64_LIBRARY) $(MODERN_MACOS_LIBRARIES) \
		$(MODERN_QUICKJS_LIBRARIES) $(LDLIBS) -o $@

$(ARM64_BINARY): $(ARM64_OBJECTS) $(ARM64_DOWNLOAD_LIBRARY) \
		$(ARM64_LIBRARY) $(ALTIVECCORE)
	...
	@$(COMPILER_ARM64) -target arm64-apple-macos$(MAC_MIN_ARM64) \
		...
		$(ARM64_DOWNLOAD_LIBRARY) $(ARM64_LIBRARY) \
...
$(MACOS_INT_DIR)/x86_64/%.o: %.c
	...
	@$(COMPILER_X64) -target x86_64-apple-macos$(MAC_MIN_X64) \
		...
		$(SOURCE_WARNING_FLAGS) -MMD -MP -MF $(@:.o=.d) -c $< -o $@
