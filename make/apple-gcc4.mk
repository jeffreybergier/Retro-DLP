...
LEGACY_QUICKJS_COMPAT_DIR := source/library/macOS/apple-gcc4/QuickJS
...
PPC_CORE_OBJECTS := $(CORE_SOURCES:%.c=$(MACOS_INT_DIR)/ppc/%.o) \
	$(MACOS_INT_DIR)/ppc/source/library/macOS/platform.o
I386_CORE_OBJECTS := $(CORE_SOURCES:%.c=$(MACOS_INT_DIR)/i386/%.o) \
	$(MACOS_INT_DIR)/i386/source/library/macOS/platform.o
...
$(PPC_LSMASH_INT_DIR)/stdio_compat.o: \
		source/library/macOS/apple-gcc4/L-SMASH/stdio_compat.c
	@mkdir -p $(dir $@)
	@MACOSX_DEPLOYMENT_TARGET=$(MAC_MIN_OLD) $(COMPILER_PPC) \
