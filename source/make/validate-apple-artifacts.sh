...
validate_minimum "$legacy_lipo" "$build_root/macOS/retro-dlp" ppc 10.4
validate_minimum "$legacy_lipo" "$build_root/macOS/retro-dlp" i386 10.4
validate_minimum "$legacy_lipo" "$build_root/macOS/retro-dlp" x86_64 10.9
validate_minimum "$legacy_lipo" "$build_root/macOS/retro-dlp" arm64 11.0
...
echo "PASS: Apple executables and libraries contain all expected architectures"
