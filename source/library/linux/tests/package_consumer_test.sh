...
cp "$source_root/source/library/linux/tests/public_header_c99.c" "$temporary/"
cp "$source_root/source/library/linux/tests/public_header_cpp.cpp" "$temporary/"
cp "$source_root/source/library/linux/tests/public_consumer.c" "$temporary/"
cd "$temporary"
