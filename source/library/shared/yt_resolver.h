...
typedef enum {
  ...
  YT_ERR_CANCELLED,
  YT_ERR_TRANSPORT_TIMEOUT,
  YT_ERR_RESPONSE_TOO_LARGE,
  YT_ERR_EJS_ASSETS_CORRUPT,
  YT_ERR_EJS_TIMEOUT,
  YT_ERR_EJS_EXCEPTION,
  YT_ERR_EJS_INVALID_RESULT,
  YT_ERR_EJS_SIGNATURE_FAILED,
  YT_ERR_EJS_N_TRANSFORM_FAILED
} YTStatus;
