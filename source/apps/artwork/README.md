...
```sh
sh source/apps/artwork/prepare_icons.sh
python3 source/apps/generate_icons.py
make apps
make app-validate
```
...
- iOS: 20 opaque RGB PNGs in `source/apps/iOS/Resources`, covering notification,
...
- macOS: `RetroDLP.iconset` contains standard 1x/2x PNG exports. The installed
  `source/apps/macOS/Resources/RetroDLP.icns` has classic 16/32/48/128-pixel
