...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)options {
  ...
  _controller.title=@"Fixture video";
  _window.rootViewController=[[[RDLPPlayerNavigationController alloc] initWithRootViewController:_controller] autorelease];
...
- (void)runTests {
  ...
  Require(navigation.navigationBar.translucent && navigation.toolbar.translucent,@"Bars overlay the video");
  ...
  for(NSValue *value in [NSArray arrayWithObjects:[NSValue valueWithCGSize:CGSizeMake(320,44)],
    ...
    bar.frame=(CGRect){CGPointZero,size};
    ...
    for(NSNumber *position in [NSArray arrayWithObjects:@0, @0.5, @1, nil]) {
      sizing.slider.value=[position floatValue];
  ...
  [navigation.view layoutIfNeeded];
  Require(navigation.navigationBarHidden && navigation.toolbarHidden,@"Both native bars hide together");
  ...
  [navigation.view layoutIfNeeded];
  Require(!navigation.navigationBarHidden && !navigation.toolbarHidden,@"Both native bars return");
  ...
  controls.slider.value=0.6f;
  [controls.slider sendActionsForControlEvents:UIControlEventValueChanged];
  controls.slider.value=0.4f;
  [controls.slider sendActionsForControlEvents:UIControlEventValueChanged];
  ...
  [controls.slider sendActionsForControlEvents:UIControlEventTouchDown];
  controls.slider.value=0.7f;
  [controls.slider sendActionsForControlEvents:UIControlEventValueChanged];
  controls.slider.value=0.8f;
  [controls.slider sendActionsForControlEvents:UIControlEventValueChanged];
